...
clean :
	-rm build/*
build/earthworms : build/display.o build/sprite.o build/font.o build/image.o build/game.o build/label.o build/cherry.o build/mixer.o build/leaf.o build/bird.o build/sound.o build/worm.o build/mob.o build/camera.o build/utils.o build/earthworms.o
	g++ -o build/earthworms build/display.o build/sprite.o build/font.o build/image.o build/game.o build/label.o build/cherry.o build/mixer.o build/leaf.o build/bird.o build/sound.o build/worm.o build/mob.o build/camera.o build/utils.o build/earthworms.o -lSDL2 -lSDL2_image -lSDL2_ttf -lSDL2_mixer
...
build/label.o : src/label.cpp src/label.h src/display.h src/image.h src/sprite.h src/drawable.h src/font.h
	g++ -o build/label.o -c src/label.cpp -Wno-write-strings
...
build/bird.o : src/bird.cpp src/game.h src/sound.h src/earthworms.h src/game.h src/bird.h src/mob.h src/sprite.h src/drawable.h src/worm.h
...
build/worm.o : src/worm.cpp src/earthworms.h src/game.h src/sound.h src/worm.h src/image.h src/cherry.h src/mob.h src/sprite.h src/drawable.h src/leaf.h src/mob.h src/sprite.h src/drawable.h
...
build/earthworms.o : src/earthworms.cpp src/mixer.h src/font.h src/label.h src/sound.h src/earthworms.h src/game.h src/display.h src/image.h src/worm.h src/cherry.h src/mob.h src/sprite.h src/drawable.h src/leaf.h src/mob.h src/sprite.h src/drawable.h src/bird.h src/mob.h src/sprite.h src/drawable.h
